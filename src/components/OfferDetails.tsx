...
const OfferDetails = ({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Ad Data Form - Redesigned to be more compact and floating at top right */}
      <div className="relative">
        <div className="sticky top-20 z-30 float-right w-full md:w-80 lg:w-96 shadow-lg rounded-lg mb-4">
          <Card className="border border-gray-800 card-gradient bg-gradient-to-br from-blue-900/40 to-slate-900">
